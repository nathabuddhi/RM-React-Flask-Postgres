...
const Alert: React.FC<AlertProps> = ({
    ...
    return (
        <div className={`border-l-4 p-4 mb-4 rounded ${alertColors[type]}`}>
            <div className="flex items-start">
                ...
                <div className="ml-auto pl-3">
                    <div className="-mx-1.5 -my-1.5">
                        <button
                            onClick={handleClose}
                            className={`inline-flex rounded-md p-1.5 focus:outline-none ${iconColors[type]} hover:bg-opacity-20 hover:bg-gray-100`}>
